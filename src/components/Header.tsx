        ...
        {isLoggedIn && (
            <nav className="hidden lg:flex items-center gap-1 p-1 bg-white/5 rounded-xl border border-white/5 mx-4">
                {isSuperAdmin ? (
                    ...
                    <>
                        <button className={navBtnClass(View.CHATS)} onClick={() => handleNavClick(View.CHATS)}>Inbox</button>
                        <button className={navBtnClass(View.RADAR)} onClick={() => handleNavClick(View.RADAR)}>Inteligencia</button>
                        <button className={navBtnClass(View.CAMPAIGNS)} onClick={() => handleNavClick(View.CAMPAIGNS)}>Campañas</button>
                        <button className={navBtnClass(View.DASHBOARD)} onClick={() => handleNavClick(View.DASHBOARD)}>Resultados</button>
                        <button className={navBtnClass(View.SETTINGS)} onClick={() => handleNavClick(View.SETTINGS)}>Cerebro</button>
                        <button className={navBtnClass(View.CONNECTION)} onClick={() => handleNavClick(View.CONNECTION)}>Nodo</button>
                    </>
                )}
            </nav>
        )}
