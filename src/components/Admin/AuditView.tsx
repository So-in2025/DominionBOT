                ...
                <div className="max-w-5xl mx-auto space-y-12 relative z-10">
                    ...
                    <div className="flex items-center gap-6 border-b border-white/10 pb-8">
                        ...
                        <div>
                            ...
                            <p className="text-gray-500 text-xs font-bold uppercase tracking-widest mt-1">ID Inquilino: {user.id}</p>
                            <div className="flex gap-2 mt-4">
                                <span className="px-3 py-1 bg-white/5 border border-white/10 rounded text-[10px] text-gray-400 font-black uppercase tracking-widest">PLAN {user.planType}</span>
