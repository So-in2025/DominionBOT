...
const HowItWorksSection = () => {
    const pillars = [
        { 
            ...
            description: "Nuestro 'Depth Engine', potenciado por Gemini, decodifica la intención real de cada mensaje. No solo respondemos, calificamos oportunidades con precisión quirúrgica." 
        },
        { 
            ...
            description: "Transforma leads descartados en capital. Comparte oportunidades que no son para ti y recibe a cambio contactos calificados que buscan exactamente lo que ofreces." 
        },
        { 
            icon: <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z" /></svg>, 
            title: "Motor de Difusión Táctica", 
            description: "Ejecuta campañas con delays heurísticos para escalar tu alcance. Nuestro Watchdog de hardware y Kill Switch global garantizan una operación segura y sin riesgos." 
        },
        { 
        ...
        { 
            ...
            description: "Monitorea métricas de conversión y la salud del sistema en tiempo real. El protocolo 'Smart Link' permite la recuperación instantánea de fallos sin tocar código." 
        },
        { 
            ...
            description: "Nuestro Radar detecta oportunidades en grupos antes que la competencia. Cuando la IA califica un lead como 'Caliente', cede el control al humano para el cierre final." 
        }
    ];
